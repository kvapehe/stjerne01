...
void loop() {
  ...
  if (timer < 10000) {
    Serial.println("1/4");
  // CRGB(255,0,0);  // CRGB(255,165,0);  // CRGB(255,255,0);
  // CRGB(0,128,0);  // CRGB(0, 0, 255);  
...
delay(PAUSE_TIME1);
    ...
    delay(PAUSE_TIME1);
    Design05(0,128,0, 238, 130, 238); // 


    // Serial.print("\n == Design01 1 Rosa == ");//CRGB(195, 78, 218)//CRGB(255, 100, 100)
    Design01(155, 100, 100); CRGB(155, 100, 100);
    // Design01(127, 0, 0); CRGB(127, 0, 0); R
    // Design01(0, 127, 0); CRGB(0, 127, 0); G
    // Design01(0, 0, 127); CRGB(0, 0, 127); B
    delay(PAUSE_TIME1 * 1);
    // Serial.print("\n == Design01 2== ");
    Design01(100, 155, 100);
    delay(PAUSE_TIME1);
    // Serial.print("\n == Design01 3== ");
    Design01(100, 100, 155);
    delay(PAUSE_TIME1);
  }
  ...
  if ( (30000 < timer) && (timer < 40000) ) {
    Serial.println("4/4");

    Design04(255, 0, 0);   // Rød
    Design04(255, 127, 0); // Gul
    Design04(255, 255, 0); // Gul
    Design04(127, 255, 0); // Gul

    Design04(0, 255, 0);   // Grønn
    Design04(0, 255, 127); // Cyan
    Design04(0, 255, 255); // Cyan
    Design04(0, 127, 255); // Cyan
    Design04(0, 0, 255);   // Blå

    Design04(127, 0, 255); // Rosa
    Design04(255, 0, 255); // Rosa
